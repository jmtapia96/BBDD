...
(
	...
	CONSTRAINT PK_ACTUA (ACTOR,ID_PELI),
	CONSTRAINT FK1_ACTUA(ACTOR) REFERENCES ACTORES(NOMBRE),
	CONSTRAINT FK2_ACTUA (ID_PELI) REFERENCES PELICULA(ID),
	CONSTRAINT CHECK_ACTUAL CHECK (PROTA IN('S','N'))
);

ALTER TABLE SOCIO ADD CONSTRAINT FK1_SOCIO FOREIGN KEY(AVALADOR) REFERENCES SOCIO(AVALADOR);