...
CREATE TABLE ESPECIE(
	...
	CONSTRAINT FK1_ESPECIE FOREIGN KEY(CALADEROPRINCIPAL) REFERENCES CALADERO (CODIGO)
);
...
INSERT INTO BARCOS (MATRICULA, NOMBRE, CLASE, CAPACIDAD, NACIONALIDAD) VALUES ('ES-5697', 'EL PEREJIL', 'ARRASTRE', 50000, 'FRANCESA');
INSERT INTO BARCOS (MATRICULA, NOMBRE, CLASE, CAPACIDAD, NACIONALIDAD) VALUES ('PT-4216', 'ARA SINTENDO', 'CERCO', 35000, 'PORTUGUESA');
...
INSERT INTO CALADERO (CODIGO, NOMBRE, UBICACION, ESPECIEPRINCIPAL, NOMBRECIENTIFICO) VALUES ('CA002', 'CAÑAMERO', 'MAR DE BUSTAMANTE', NULL, 'SAN JOSELUS');
